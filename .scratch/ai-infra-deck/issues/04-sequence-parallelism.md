...
- [x] `.scratch/ai-infra-deck/04-sequence-parallelism/outline.md` 大纲经作者确认，通讯代价数字可复算并与第②章代价模型一致
- [x] Ulysses / Ring-Attention / MagiAttention 三方案对比清晰，落点为长视频 token 序列
- [x] `deck/chapters/03-sequence-parallelism.html` 与共享主题同构，可独立打开
